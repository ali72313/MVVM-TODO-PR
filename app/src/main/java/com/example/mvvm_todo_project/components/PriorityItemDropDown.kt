...
import com.example.mvvm_todo_project.ui.theme.PRIORITY_DROP_DOWN_HEIGHT
...
fun PriorityItemDropDownPreview() {
    PriorityItemDropDown(priority = Priority.LOW, onPrioritySelected = {})
}